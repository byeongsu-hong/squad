...
function VaultsContent() {
  ...
  return (
    <div className="flex items-start gap-0">
      ...
      {selectedMultisigKey && (
        <div className="bg-card border-border flex-1 py-6 lg:flex-none lg:w-[44%] lg:min-w-[400px] lg:border-l lg:sticky lg:top-[54px] lg:max-h-[calc(100svh-54px)] lg:overflow-y-auto">
          <VaultDetail
