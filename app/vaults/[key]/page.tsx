...
export default function VaultDetailPage({
  ...
  return (
    <div className="mx-auto flex max-w-[1280px] items-start gap-0">
      ...
      <div className="bg-background border-border flex-1 px-4 py-6 lg:flex-none lg:w-[480px] lg:shrink-0 lg:border-l lg:sticky lg:top-[54px] lg:max-h-[calc(100svh-54px)] lg:overflow-y-auto">
        <VaultDetail
          vaultKey={vaultKey}
